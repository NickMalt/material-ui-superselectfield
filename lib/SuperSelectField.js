...
var SelectField = function (_Component2) {
  ...
  function SelectField(props, context) {
    ...
    _this3.changeSearchText = function (searchText, callback) {
      _this3.props.onAutoCompleteTyping(searchText);
      _this3.setState({ searchText: searchText }, callback);
    };

    _this3.handleTextFieldAutocompletionFiltering = function (event, searchText) {
      _this3.changeSearchText(searchText, function () {
    ...
    _this3.handleMenuSelection = function (selectedItem) {
      return function (event) {
        ...
        if (_this3.props.multiple) {
          ...
          _this3.setState({ selectedItems: updatedValues }, function () {
            _this3.props.onChange(_this3.state.selectedItems, _this3.props.name);
          });
        } else {
  ...
  _createClass(SelectField, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          loadingPlaceholderText = _props2.loadingPlaceholderText;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            loading ? _react2.default.createElement(_ListItem2.default, { primaryText: loadingPlaceholderText, style: { cursor: 'default', padding: '10px 16px' }, disabled: true }) : menuItems.length ? _react2.default.createElement(
...
SelectField.propTypes = {
  ...
  floatingLabel: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.node]),
  ...
  autocompleteUnderlineStyle: _react.PropTypes.object,
  autocompleteUnderlineFocusStyle: _react.PropTypes.object,
  hintText: _react.PropTypes.string,
  hintTextAutocomplete: _react.PropTypes.string,
  noMatchFound: _react.PropTypes.string,
  loading: _react.PropTypes.bool,
  loadingPlaceholderText: _react.PropTypes.string,
  ...
  onAutoCompleteTyping: _react.PropTypes.func
};
